...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        TeachingAssistantStorage teachingAssistantStorage =
                new JsonTeachingAssistantStorage(userPrefs.getAddressBookFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        Optional<ReadOnlyTeachingAssistant> addressBookOptional;
        ReadOnlyTeachingAssistant initialData;
        try {
            addressBookOptional = storage.readTeachingAssistant();
